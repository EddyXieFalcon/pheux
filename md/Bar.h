...
namespace Pheux { namespace Core {
	...
	protected:
		...
		virtual bool isComplete(const DateTime& ttime) const
		{
	...
	private:
		virtual bool isComplete(DateTime* ttime) const { return true; }
	};
